...
class Voice(commands.Cog):
    ...
    async def _kick(self, ctx, *, member: discord.Member):
        if member.voice is None:
            embed = discord.Embed(title="<:feast_cross:1400143488695144609> Error",
                description=f"{str(member)} is not connected to any voice channel",
                color=self.color)
            embed.set_footer(text=f"Requested by: {ctx.author}",
                               icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
            embed.set_thumbnail(url="https://cdn.discordapp.com/emojis/1279464563150032991.png")
            return await ctx.reply(embed=embed)
        ch = member.voice.channel.mention if member and member.voice and member.voice.channel else "(unknown channel)"
        await member.edit(voice_channel=None,
                          reason=f"Disconnected by {str(ctx.author)}")
        embed2 = discord.Embed(title="<:feast_tick:1400143469892210753> Success",
    ...
    async def _mute(self, ctx, *, member: Optional[discord.Member] = None):
        ...
        if member.voice.mute == False:
            embed2 = discord.Embed(title="<:feast_cross:1400143488695144609> Error",
                description=f"{str(member)} is already unmuted in the voice channel.",
                color=self.color)
            embed2.set_footer(text=f"Requested by: {ctx.author}",
                               icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
            embed2.set_thumbnail(url="https://cdn.discordapp.com/emojis/1279464563150032991.png")
            return await ctx.reply(embed=embed2)
        ch = member.voice.channel.mention if member and member.voice and member.voice.channel else "(unknown channel)"
        embed3 = discord.Embed(title="<:feast_tick:1400143469892210753> Success",
...
# Remove stray code block after _mute that is outside any function
        ...
        ch_mention = member.voice.channel.mention if member and member.voice and member.voice.channel else "(unknown channel)"
        embed = discord.Embed(
            title="<:feast_tick:1400143469892210753> Success",
            description=f"{str(member)} has been muted in {ch_mention}.",
            color=self.color
        )
        embed.set_footer(
            text=f"Requested by: {ctx.author}",
    ...
    async def _deafen(self, ctx, *, member: discord.Member):
        if member.voice is None:
            embed = discord.Embed(title="<:feast_cross:1400143488695144609> Error",
                description=f"{str(member)} is not connected to any of the voice channel",
                color=self.color)
            embed.set_footer(text=f"Requested by: {ctx.author}",
                               icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
            embed.set_thumbnail(url="https://cdn.discordapp.com/emojis/1279464563150032991.png")
        ...
        if member.voice.deaf == True:
            embed2 = discord.Embed(title="<:feast_cross:1400143488695144609> Error",
                description=f"{str(member)} is already deafened in the voice channel",
                color=self.color)
            embed2.set_footer(text=f"Requested by: {ctx.author}",
                               icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
            embed2.set_thumbnail(url="https://cdn.discordapp.com/emojis/1279464563150032991.png")
    ...
    async def _undeafen(self, ctx, *, member: discord.Member):
        ...
        if member.voice.deaf == False:
            embed2 = discord.Embed(title="<:feast_cross:1400143488695144609> Error",
                description=f"{str(member)} is already undeafened in the voice channel",
                color=self.color)
            embed2.set_footer(text=f"Requested by: {ctx.author}",
                               icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
            embed2.set_thumbnail(url="https://cdn.discordapp.com/emojis/1279464563150032991.png")
    ...
    async def _moveall(self, ctx, *, channel: discord.VoiceChannel):
        ...
        try:
            ...
            embed3 = discord.Embed(title="<:feast_cross:1400143488695144609> Error",
