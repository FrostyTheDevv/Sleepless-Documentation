...
class Extraowner(commands.Cog):
    ...
    async def extraowner(self, ctx, option: Optional[str] = None, user: Optional[discord.Member] = None):
        ...
        if option.lower() == 'set':
            ...
            if view.value is None:
                ...
                await message.edit(content="<:feast_cross:1400143488695144609> Action cancelled.", embed=None, view=None)
            ...
            if not row:
                ...
                if view.value is None:
                    ...
                    await self.db.commit()
                    embed = discord.Embed(title="<:Feast_tick:1227866641027698792> Success",
                        description="Disabled Extraowner Configuration!",
                        color=0x006fb9
                    )
                    await message.edit(embed=embed, view=None)
                else:
                    await message.edit(content="<:feast_cross:1400143488695144609> Action canceled.", embed=None, view=None)
