...
class Messages(commands.Cog):
    ...
    @commands.group()
    async def __ChatManagement__(self, ctx: commands.Context):
        """`clearmsg` , `purge` , `clearmsg embeds` , `clearmsg files` , `clearmsg images` , `clearmsg all` , `clearmsg user` , `clearmsg contains` , `clearmsg bot` , `clearmsg emoji` , `clearmsg reactions` , `snipe` , `purgebots` , `purgeuser` , `messages`"""
