    ...
    async def on_message(self, message):
        ...
        if self.bot.user in message.mentions:
            if len(message.content.strip().split()) == 1:
                ...
                embed.set_footer(text="Powered by Sleepless Development™", icon_url=self.bot.user.avatar.url)

                buttons = [
                    discord.ui.Button(label="Invite", style=discord.ButtonStyle.link, url="https://discord.com/oauth2/authorize?client_id=1414317652066832527&permissions=8&integration_type=0&scope=bot+applications.commands"),
                    discord.ui.Button(label="Dashboard - Coming Soon", style=discord.ButtonStyle.secondary, disabled=True),
                    discord.ui.Button(label="Support", style=discord.ButtonStyle.link, url="https://discord.gg/5wtjDkYbVh"),
                ]
